...
do
    ...
    SP_REST_PATH=/data1/projects/RTMA/alex.schein/URMA_train_test/LOOSE_FILES/train/${VAR_OF_INTEREST}
    
    ##### Concatenate files. MUST MAKE SURE THEY ARE ORDERED AND ALL CORRECT #####
    output_filename=train_urma_alltimes_${VAR_OF_INTEREST}.grib2
