...
START_DATE = date(2023,7,27) #date(2021,1,1) #should be jan 1, 2021
END_DATE = date(2024,12,31) #should be dec 31, 2024
NUM_DAYS = END_DATE-START_DATE

for var_string in ["spfh2m"]: #list(var_select_dict.keys())[1:]: #don't need t2m right now, but change this if we do later
    ...
    H = Herbie(f"2022-04-22 03:00", model="hrrr", fxx=1, save_dir=PATH_TO_DOWNLOAD_TO, verbose=False)
    H.download(var_select_dict[var_string])
