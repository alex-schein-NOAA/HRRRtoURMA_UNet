...
for epoch in range(1,test_model_attrs.NUM_EPOCHS+1):
    ...
    if epoch%50 == 0: #save a checkpointed model every 50 epochs
        torch.save(model.module.state_dict(), f"{TRAINED_MODEL_SAVEPATH}/CHECKPOINT_EPOCH{epoch}_{test_model_attrs.savename}.pt")
