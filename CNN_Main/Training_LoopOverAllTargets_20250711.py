...
TARGET_VAR_LIST = ["d2m", "pressurf", "u10m", "v10m", ["u10m", "v10m"]] #don't need t2m, already have that. Also want a model that targets both u and v at the same time, but only those vars
