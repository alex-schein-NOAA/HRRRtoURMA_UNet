...
class SR_UNet_simple_2x2(nn.Module): #Only dealing with temperature input and output for now
    def __init__(self, 
                 n_channels_in=1, #change if inputting more channels (e.g. terrain)
                 n_channels_firstlayer=64, 
                 n_channels_out=1
                ): 
        super(SR_UNet_simple_2x2, self).__init__()
