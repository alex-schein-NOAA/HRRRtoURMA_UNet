...
class HRRR_URMA_Dataset_Anytime_Anydate_Anyterrain(Dataset):
    def __init__(self, 
        ...
        terrain_path_urma = os.path.join(path_root, "Terrain_Maps", "terrain_subset_namsmarttopconus2p5.nc")
        if is_train:
            data_save_path_pred = os.path.join(path_root,"Regridded_HRRR_train_test", "train_hrrr_00z_12z.nc")
            data_save_path_targ = os.path.join(path_root,"URMA_train_test", "train_urma_00z_12z.nc")
        else:
            data_save_path_pred = os.path.join(path_root,"Regridded_HRRR_train_test", "test_hrrr_00z_12z.nc")
            data_save_path_targ = os.path.join(path_root,"URMA_train_test", "test_urma_00z_12z.nc")
